...
const Item: React.FC<ItemProps> = ({ title, isSelected, onSelect }) => {
    ...
    const itemIcon = {
        "Dashboard": <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M10 3H3V12H10V3Z" stroke="white" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M21 3H14V8H21V3Z" stroke="white" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M21 12H14V21H21V12Z" stroke="white" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M10 16H3V21H10V16Z" stroke="white" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
        ,
        "Claim assets": <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M19 5C17.5 5 16.2 6.4 16 7C12.5 5.5 5 6.7 5 12C5 13.8 5 15 7 16.5V20H11V18H14V20H18V16C19 15.5 19.7 15 20 14H22V10H20C20 9 19.5 8.5 19 8V5Z" stroke="white" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M2 9V10C2 11.1 2.9 12 4 12H5" stroke="white" stroke-linecap="round" stroke-linejoin="round" />
        </svg>,
